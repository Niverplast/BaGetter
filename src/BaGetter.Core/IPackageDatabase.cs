...
public interface IPackageDatabase
{
    ...
    Task<IReadOnlyList<Package>> FindAsync(Guid feedId, string id, bool includeUnlisted, CancellationToken cancellationToken);
    ...
    Task<bool> ExistsAsync(Guid feedId, string id, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to cancel the task.</param>
    /// <returns>Whether the package exists in the database.</returns>
    Task<bool> ExistsAsync(Guid feedId, string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    Task<bool> UnlistPackageAsync(Guid feedId, string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to cancel the task.</param>
    /// <returns>False if the package does not exist.</returns>
    Task<bool> RelistPackageAsync(Guid feedId, string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    Task AddDownloadAsync(Guid feedId, string id, NuGetVersion version, CancellationToken cancellationToken);
    ...
    Task<bool> HardDeletePackageAsync(Guid feedId, string id, NuGetVersion version, CancellationToken cancellationToken);
}
